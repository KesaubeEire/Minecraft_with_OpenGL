...
{
    if (object->x >= px && object->x + object->xSize <= px + x_size && object->y >= py && object->y + object->ySize <= py + y_size && object->z >= pz && object->z + object->zSize <= pz + z_size)
        return true;
    return false;
}
...
{
    if (octreeNode->x >= px && octreeNode->x + octreeNode->xSize <= px + x_size && octreeNode->y >= py && octreeNode->y + octreeNode->ySize <= py + y_size && octreeNode->z >= pz && octreeNode->z + octreeNode->zSize <= pz + z_size)
        return true;
    return false;
}
...
{
    if (octreeNode->x > px + x_size || octreeNode->x + xSize < px || octreeNode->y > py + y_size || octreeNode->y + ySize < py || octreeNode->z + zSize < pz || octreeNode->z > pz + z_size)
        return false;
    return true;
}
